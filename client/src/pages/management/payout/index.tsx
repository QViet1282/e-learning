...
const PayoutPage: React.FC = () => {
  ...
  const searchTitle = t('payoutManagement.searchTitle')
      ...
      <div className="mt-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className='lg:w-2/3 w-full gap-2 flex'>
          <div className='p-2 border-2 rounded-lg shadow-sm bg-white flex items-center'>
            <p>{totalItems} {t('payoutManagement.request')}</p>
          </div>
          <select
          ...
          >
            <option value="">{t('payoutManagement.allStatus')}</option>
            <option value="Success">{t('payoutManagement.success')}</option>
            <option value="Pending">{t('payoutManagement.pending')}</option>
            <option value="Fail">{t('payoutManagement.fail')}</option>
          </select>
        </div>
