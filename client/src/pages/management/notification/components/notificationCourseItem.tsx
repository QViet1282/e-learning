...
import { AccessTime, Link } from '@mui/icons-material'
...
const NotificationCourseItem: FC<NotificationItemProps> = ({ notification, handleDelete }) => {
...
export default NotificationCourseItem
