  ...
  return (
    <div className="border-t-2 border-gray-200">
      ...
      <div className="text-base border-x-2 p-2">
        <div dangerouslySetInnerHTML={{ __html: studyItem.description }} />
      </div>
      ...
      <div className="border-2 border-gray-200 p-2">
                  ...
                  <Draggable key={question.id} draggableId={String(question.id)} index={index}>
                    {(provided: DraggableProvided) => (
                      <div
                        ...
                        className="flex items-center group w-full justify-between"
                      >
                        <div className="flex items-center">
                          <div className="font-medium text-sm">Câu {question.order}: </div>
                          <div className='ml-1' dangerouslySetInnerHTML={{ __html: question.content ?? '' }} />
                          <div className='ml-2 opacity-0 group-hover:opacity-100 flex justify-between items-center' >
        ...
        {isAddingQuestion ? (
          ...
          <div
            className="cursor-pointer flex justify-center text-white bg-teal-500 w-32 p-1"
